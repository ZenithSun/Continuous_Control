...
The notebook `Continuous_Control.ipynb` contains the code to solve the reinforecement problem. The core solution to the problem is a Deep Deterministic Policy Gradient approach(DDPG), please see this [paper](https://arxiv.org/pdf/1509.02971.pdf).
